...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'The Tales of China', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Your portal to the enchanting world of Chinese folklore and mythology.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chntales.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ancient Chinese tales,legendary heroes,mythical creatures,timeless romances,epic battles,Chinese folklore,Chinese mythology', // 网站关键词 英文逗号隔开
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@TheTalesofChina', // Youtube主页
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'QK7E39SRH4', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || '5f4d2afba284e0651c7e3a0ea2ad8bbc', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY: process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || 'b8fcff51d17246fab03c01c90a267231', // 客户端搜索用的KEY
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || 'tales_of_china', // 在Algolia中创建一个index用作数据库
